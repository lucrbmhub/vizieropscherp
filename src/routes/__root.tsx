...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Loopbaancoaching voor werkgevers | Amsterdam & Haarlem | Vizier op Scherp" },
      ...
      { property: "og:title", content: "Loopbaancoaching voor werkgevers | Amsterdam & Haarlem | Vizier op Scherp" },
      { property: "og:description", content: "Regionaal netwerk voor loopbaancoaching in Amsterdam, Haarlem en omgeving." },
