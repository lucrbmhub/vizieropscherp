...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `${SITE_URL}/assets/social-share.jpg` },
      { property: "og:image:secure_url", content: `${SITE_URL}/assets/social-share.jpg` },
      { property: "og:image:type", content: "image/jpeg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Vizier op Scherp — loopbaancoaching in Amsterdam en Haarlem" },
      { name: "twitter:image", content: `${SITE_URL}/assets/social-share.jpg` },
    ],
    links: [
